...
function Charrt({ loanno, ledger, company, date }) {
    ...
    return (
        <Container className="rounded bg-white" style={{ paddingLeft: "25px" }}>
            <Row style={{ paddingLeft: "5px" }} className='print-margin '>
                <Form>
            ...
            <Row className={(Number(process.env.REACT_APP_LOAN_APP_STARTDATE) === 0) ? 'col-sm-8 col-md-8 print-margin ' : 'col-sm-8 col-md-8'} style={{ paddingLeft: paddingvar }} >
            ...
            {(Number(process.env.REACT_APP_LOAN_APP_STARTDATE) === 0) ?
                <Row className='col-sm-8 col-md-8 mt-0 pt-0 print-margin ' style={{ paddingLeft: "14px", whiteSpace: "nowrap", overflow: "hidden" }}>
