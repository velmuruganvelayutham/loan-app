...
function Charrt({ loanno, ledger, company, date }) {
    ...
    return (
        <Container className="rounded bg-white " style={{ paddingLeft: "25px" }}>
            <Row style={{ paddingLeft: "5px" }} className='print-margin-chartalign'>
                <Form>
            ...
            <Row className={(Number(process.env.REACT_APP_LOAN_APP_STARTDATE) === 0) ? 'col-sm-8 col-md-8 print-margin-chartalign' : 'col-sm-8 col-md-8'} style={{ paddingLeft: paddingvar }} >
                <Col className={(Number(process.env.REACT_APP_LOAN_APP_STARTDATE) === 0) ? 'col-sm-4 col-md-4 p-0' : 'col-sm-4 col-md-4 p-0'} >
                    <Table className="table text-center table-bordered border-dark chart col-sm-custom_chart" style={{ marginBottom: "0 !important",width:"90%" }}>
                        <thead>
                            <tr >
                ...
                <Col className={(Number(process.env.REACT_APP_LOAN_APP_STARTDATE) === 0) ? 'col-sm-custom col-md-4 p-0' : 'col-sm-custom col-md-4 p-0'}  >
                    <Table className="table  text-center table-bordered border-dark chart col-sm-custom chart-print-margin" style={{ marginBottom: "0 !important",width:"40%"}}>
                        <thead>
                            <tr >
